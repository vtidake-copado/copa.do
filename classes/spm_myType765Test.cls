@isTest
public with sharing class spm_myType765Test {
    @isTest static void testDefaultDescription(){
        Account acc = new Account(Name = 'My Test Account');
        insert acc;
        acc = spm_myType765.setDefaultDescription(acc);
    ...
    @isTest static void testDefaultBillingAddress(){
        Account acc = new Account(Name = 'My Test Account');
        insert acc;
        acc = spm_myType765.setDefaultBillingAddress(acc);
    ...
    @isTest static void testDefaultShippingAddress(){
        Account acc = new Account(Name = 'My Test Account');
        insert acc;
        acc = spm_myType765.setDefaultShippingAddress(acc);
    ...
    @isTest static void testDefaultPhone(){
        Account acc = new Account(Name = 'My Test Account');
        insert acc;
        acc = spm_myType765.setDefaultPhone(acc);
    ...
    @isTest static void testDefaultURL(){
        Account acc = new Account(Name = 'My Test Account');
        insert acc;
        acc = spm_myType765.setDefaultURL(acc);
