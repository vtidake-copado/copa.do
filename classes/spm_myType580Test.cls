@isTest
public with sharing class spm_myType580Test {
    @isTest static void testDefaultDescription(){
        Account acc = new Account(Name = 'My Test Account');
        insert acc;
        acc = spm_myType580.setDefaultDescription(acc);
    ...
    @isTest static void testDefaultBillingAddress(){
        Account acc = new Account(Name = 'My Test Account');
        insert acc;
        acc = spm_myType580.setDefaultBillingAddress(acc);
    ...
    @isTest static void testDefaultShippingAddress(){
        Account acc = new Account(Name = 'My Test Account');
        insert acc;
        acc = spm_myType580.setDefaultShippingAddress(acc);
    ...
    @isTest static void testDefaultPhone(){
        Account acc = new Account(Name = 'My Test Account');
        insert acc;
        acc = spm_myType580.setDefaultPhone(acc);
    ...
    @isTest static void testDefaultURL(){
        Account acc = new Account(Name = 'My Test Account');
        insert acc;
        acc = spm_myType580.setDefaultURL(acc);
