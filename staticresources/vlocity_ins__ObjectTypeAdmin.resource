...
},{"./CpqDirectives.js":1,"./modules/objecttypeadmin/controller/ObjectTypeAdminController.js":35,"./modules/objecttypeadmin/factory/ObjectTypeService.js":36}],3:[function(require,module,exports){
...
.controller('ObjectTypeAdminController', ['$scope', '$location', '$timeout', '$compile', 'remoteActions', 'objectTypeService',
    function ($scope, $location, $timeout, $compile, remoteActions, objectTypeService) {
        $scope.OBJECT_NAME = 'ObjectClass__c';
        $scope.nsp = fileNsPrefix();
        ...
        $scope.openFacetDetails = function(facetType, facetData, data) {
            ...
            if (facetType === 'ATTR_METADATA') {
                ...
                compiledHTML = $compile('<vloc-attribute-metadata object-id="objectId" attr-obj="attrObj" attr-assgn-obj="attrAssgnObj" override-mode="false"></vloc-attribute-metadata>')($scope);
                ...
                'sections': [
                    {
                        ...
                        'sectionElements': [
                            ...
                            //     'Id': 'se4',
                            //     'Name': 'Parent Object Type',
                            //     'FieldApiName__c': 'ParentObjectTypeId__c'
                            // }
                        ],
                        'sectionObj': {
                            'Name': 'General Properties'
