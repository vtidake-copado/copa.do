...
(function configIFrameResizerContentPage (window) {
    var ignoreSelector = '.data-iframe-ignore,.data-iframe-ignore-children *';

    window.iFrameResizer = {
        heightCalculationMethod: getBestHeight
    }
    ...
    function getBestHeight() {
        return Math.max(document.documentElement.offsetHeight, getMaxElement('bottom', getAllElementsIgnore()));
    }
