...
},{"./modules/cpqdirectives/controller/NewObjectRecordController.js":4,"./modules/cpqdirectives/directive/VlocAssignAttrsFields.js":5,"./modules/cpqdirectives/directive/VlocAttachment.js":6,"./modules/cpqdirectives/directive/VlocAttachments.js":7,"./modules/cpqdirectives/directive/VlocAttribute.js":8,"./modules/cpqdirectives/directive/VlocAttributeMetadata.js":9,"./modules/cpqdirectives/directive/VlocContextRule.js":10,"./modules/cpqdirectives/directive/VlocContextRules.js":11,"./modules/cpqdirectives/directive/VlocCustomView.js":12,"./modules/cpqdirectives/directive/VlocDataTable.js":13,"./modules/cpqdirectives/directive/VlocFieldMetadata.js":14,"./modules/cpqdirectives/directive/VlocGlobalPricingElements.js":15,"./modules/cpqdirectives/directive/VlocImgCarousel.js":16,"./modules/cpqdirectives/directive/VlocLayoutElement.js":17,"./modules/cpqdirectives/directive/VlocLayoutManagement.js":18,"./modules/cpqdirectives/directive/VlocObjAttrsFields.js":19,"./modules/cpqdirectives/directive/VlocObjField.js":20,"./modules/cpqdirectives/directive/VlocObjectPricing.js":21,"./modules/cpqdirectives/directive/VlocObjectPricingElement.js":22,"./modules/cpqdirectives/directive/VlocObjectPricingElements.js":23,"./modules/cpqdirectives/directive/VlocObjectType.js":24,"./modules/cpqdirectives/directive/VlocObjectTypes.js":25,"./modules/cpqdirectives/directive/VlocOfferPricingComponent.js":26,"./modules/cpqdirectives/directive/VlocPriceListEntryInfoCard.js":27,"./modules/cpqdirectives/directive/VlocPricingElement.js":28,"./modules/cpqdirectives/directive/VlocProdChildDetails.js":29,"./modules/cpqdirectives/directive/VlocProdChildItem.js":30,"./modules/cpqdirectives/directive/VlocProductAttributes.js":31,"./modules/cpqdirectives/directive/VlocProductPricing.js":32,"./modules/cpqdirectives/directive/VlocStandalonePricingElements.js":33,"./modules/cpqdirectives/factory/CpqService.js":34,"./modules/cpqdirectives/templates/templates.js":35}],2:[function(require,module,exports){
...
require('./modules/productadmin/directive/VlocAttributeRules.js');
require('./modules/productadmin/directive/VlocProdInfo.js');
require('./modules/productadmin/directive/VlocProductDetails.js');
require('./modules/productadmin/directive/VlocProductStructure.js');
require('./modules/productadmin/factory/ProductAdminService.js');
require('./modules/productadmin/templates/templates.js');

},{"./CpqDirectives.js":1,"./modules/productadmin/controller/ProductAdminController.js":36,"./modules/productadmin/directive/VlocAttributeRules.js":37,"./modules/productadmin/directive/VlocProdInfo.js":38,"./modules/productadmin/directive/VlocProductDetails.js":39,"./modules/productadmin/directive/VlocProductStructure.js":40,"./modules/productadmin/factory/ProductAdminService.js":41,"./modules/productadmin/templates/templates.js":42}],3:[function(require,module,exports){
angular.module('promotionadmin', ['vlocity', 'ngSanitize', 'cpqdirectives', 'sldsangular', 'productadmin'])
.config(['remoteActionsProvider', function(remoteActionsProvider) {
    remoteActionsProvider.setRemoteActions(window.remoteActions || {});
}])
.config(['$locationProvider', function($locationProvider) {
...
require('./modules/promotionadmin/directive/VlocPromoProdDiscounts.js');
...
require('./ProductAdmin.js');

},{"./CpqDirectives.js":1,"./ProductAdmin.js":2,"./modules/promotionadmin/controller/PromotionAdminController.js":43,"./modules/promotionadmin/directive/VlocPromoProdDiscounts.js":44,"./modules/promotionadmin/directive/VlocPromotionProduct.js":45,"./modules/promotionadmin/directive/VlocPromotionProducts.js":46,"./modules/promotionadmin/templates/templates.js":47}],4:[function(require,module,exports){
...
.controller('ProductAdminController', ['$scope', '$rootScope', '$location', '$timeout', '$compile', 'remoteActions', '$q',
    function ($scope, $rootScope, $location, $timeout, $compile, remoteActions, $q) {
        $scope.OBJECT_NAME = 'Product2';
        $scope.nsp = fileNsPrefix();
        ...
        $scope.$on('refreshContextCriteriaItems', function(event, data) {
            $scope.getContextCriteria(data);
        });
        ...
        $scope.getObjectFieldsAndLayoutById = function(objectId, forSelf) {
            console.log('!!! getObjectFieldsAndLayoutById ');
            remoteActions.getObjectLayoutById(objectId, forSelf).then(function(results) {
                $scope.buildObjectLayout(results);
        ...
        $scope.describeObject = function(objectName) {
            remoteActions.describeObject(objectName).then(function(results) {
                console.log('describeObject product results: ', results);
                $scope.objectFields = results;
            });
        };
        ...
        $scope.describeObjectById = function(objectId) {
            remoteActions.describeObjectbyId(objectId).then(function(results) {
                console.log('describeObjectById product results: ', results);
                $scope.objectFields = results;
            });
        };
        ...
        $scope.getContextCriteria = function(productId) {
            console.log('getContextCriteria for: ', productId);
            if (productId !== undefined) {
                remoteActions.getContextCriteria(productId).then(function(results) {
                    console.log('getContextCriteria results: ', results);
                    $scope.contextCriteria = results;
                    $rootScope.$broadcast('setContextCriteria', $scope.contextCriteria);
                });
            }
        ...
        $scope.saveItem = function(event) {
            console.log('SAVE PRODUCT $scope.attrObjMap: ', $scope.attrObjMap);
            console.log('SAVE PRODUCT $scope.attrAssgnObjMap: ', $scope.attrAssgnObjMap);
            var originalText;
            if (event) {
                originalText = event.currentTarget.innerText;
                event.currentTarget.disabled = true;
            ...
            var itemToSave = {};
            for (var key in $scope.editProduct) {
                if (key !== '$$hashKey') {
                    if ($scope.editProduct[key] !== null) {
                        itemToSave[key] = $scope.editProduct[key];
                    } else {
            ...
            remoteActions.updateObject(itemToSave).then(function(results) {
                ...
                if (attrAssgnPromises.length > 0) {
                    $q.all(attrAssgnPromises).then(function(data) {
                        ...
                        // publish product
                        remoteActions.publishProduct($scope.productId).then(function(response) {
                            console.log('publishProduct executed: ', response);
                        });
                    });
                }
        ...
        $scope.saveAttributeAssignmentPromise = function(attrAssgnObj) {
            ...
            remoteActions.saveAttributeAssignment(attrAssgnObj).then(function(response) {
        ...
        $scope.openFacetDetails = function(facetType, facetData) {
            ...
            if (facetType === 'ATTACHMENT_ITEM') {
            ...
            } else if (facetType === 'CONTEXT_CRITERIA_ITEM') {
                $scope.contextCriteriaItem = facetData.contextCriteriaItem;
                compiledHTML = $compile('<vloc-context-rule item="contextCriteriaItem" parent-item="product"></vloc-context-rule>')($scope);
                j$('#facet-detail-content').html(compiledHTML);
                ...
                directiveHTML = '<vloc-attribute-metadata object-id="objectId" attr-obj="attrObj" attr-assgn-obj="attrAssgnObj" ' +
                    ...
                    'attr-assgn-override-obj="null" attr-override-def-obj="null"></vloc-attribute-metadata>';
                ...
                directiveHTML = '<vloc-prod-child-details root-product-id="rootProductId" root-product-spec-id="rootProductSpecId" ' +
                    'prod-child-item="prodChildItem" pricing-mode="pricingMode"></vloc-prod-child-details>';
                compiledHTML = $compile(directiveHTML)($scope);
                j$('#facet-detail-content').html(compiledHTML);
                ...
                directiveHTML = '<vloc-pricing-element object-id="objectId" pricing-element-item="pricingElementItem" parent-item="product" pricing-mode="pricingMode" is-adj="isAdj"></vloc-pricing-element>';
                compiledHTML = $compile(directiveHTML)($scope);
                j$('#facet-detail-content').html(compiledHTML);
                ...
                $scope.isAdj = facetData.isAdj;
                directiveHTML = '<vloc-pricing-element object-id="productId" price-list-entry-item="priceListEntryItem" pricing-element-object-type="pricingElementObjectType" parent-item="product" pricing-mode="pricingMode" is-adj="isAdj"></vloc-pricing-element>';
                compiledHTML = $compile(directiveHTML)($scope);
                j$('#facet-detail-content').html(compiledHTML);
            }
        ...
        $scope.init = function() {
            ...
            // $scope.getObjectLayoutById($scope.productId, true);
            // $scope.describeObjectFieldsById($scope.productId, $scope.sectionElementFields);
            $scope.getObjectPicklistsByName($scope.OBJECT_NAME);
...
angular.module('productadmin')
.directive('vlocAttributeRules', ['remoteActions',
    function(remoteActions) {
        return {
            scope: {
                customViewAttrs: '='
            ...
            replace: true,
            restrict: 'E',
            templateUrl: 'AttributeRules.tpl.html',
            controller: function($scope, $rootScope, $sldsModal) {
                console.log('INIT: ', $scope.customViewAttrs);
                $scope.nsp = fileNsPrefix();
            }
...
angular.module('productadmin')
.directive('vlocProdInfo', ['remoteActions',
    function(remoteActions) {
        return {
            scope: {
                productId: '=',
            ...
            controller: function($scope, $rootScope, $timeout) {
                ...
                $scope.getObjectLayoutById = function(objectId, forSelf) {
                    remoteActions.getObjectLayoutById(objectId, forSelf).then(function(results) {
                        console.log('getObjectLayoutById product info results: ', results);
                        $scope.buildObjectLayout(results);
                    });
                };
                ...
                $scope.buildObjectLayout = function(results) {
                    ...
                    console.log('FACETS for product info: ', $scope.facets);
                };

                $scope.describeObject = function(objectName) {
                    remoteActions.describeObject(objectName).then(function(results) {
                        console.log('describeObject product info results: ', results);
                        $scope.objectFields = results;
                    });
                };
...
angular.module('productadmin')
.directive('vlocProductDetails', ['remoteActions',
    function(remoteActions) {
        return {
            scope: {
                customViewAttrs: '='
            ...
            replace: true,
            restrict: 'E',
            templateUrl: 'ProductDetails.tpl.html',
            controller: function($scope, $timeout) {
                console.log('INIT: ', $scope.customViewAttrs);
                $scope.nsp = fileNsPrefix();
                $scope.productId = $scope.customViewAttrs.objectId;
                $scope.product = $scope.customViewAttrs.productObj;
                $scope.attachments = $scope.customViewAttrs.items;
                ...
                $scope.saveProduct = function(event) {
                    ...
                    var itemToSave = {};
                    for (key in $scope.editProduct) {
                        if (key !== '$$hashKey') {
                            itemToSave[key] = ($scope.editProduct[key] === null ? undefined : $scope.editProduct[key]);
                        }
                    }
                    ...
                    remoteActions.updateObject(itemToSave).then(function(results) {
                        ...
                        for (var key in results) {
                            if ($scope.objectFields[key] && $scope.objectFields[key].type === 'DATE') {
                                var tzOffset = (window.userTimezoneOffset || window.parent.userTimezoneOffset);
                                $scope.editProduct[key] = results[key] + tzOffset;
                                $scope.product[key] = results[key] + tzOffset;
                            } else {
                                $scope.editProduct[key] = results[key];
                                $scope.product[key] = results[key];
                            }
                        }
                        //TODO: show save success message
                ...
                $scope.publishProduct = function(event) {
                    var originalText;
                    if (event) {
                        originalText = event.currentTarget.innerText;
                        event.currentTarget.disabled = true;
                        event.currentTarget.innerText = 'Publishing...';
                    }

                    remoteActions.publishProduct($scope.productId).then(function(results) {
                        console.log('publish product results: ', results);
                        if (event) {
                            event.currentTarget.innerText = originalText;
                            event.currentTarget.disabled = false;
                        }
...
angular.module('productadmin')
.directive('vlocProductStructure', ['remoteActions',
    function(remoteActions) {
        return {
            scope: {
                customViewAttrs: '='
            ...
            controller: function($scope, $rootScope, $sldsModal, $compile) {
                console.log('INIT ProductStructure: ', $scope.customViewAttrs);
                $scope.productId = $scope.customViewAttrs.objectId;
                ...
                $scope.getFieldSets = function() {
                    remoteActions.getFieldSetsByName('Product2').then(function(results) {
                    ...
                    remoteActions.getFieldSetsByName($scope.nsp + 'ProductChildItem__c').then(function(results) {
                        if (results[$scope.nsp + 'productstructure'] === undefined) {
                ...
                $scope.getProductStructure = function() {
                    remoteActions.getProdStructureItems($scope.productId).then(function(results) {
                        var productList = [];
                        var path = [];
                        angular.forEach(results, function(prod, idx) {
                            prod.pciObj = ((prod.productChildItemSOOverride === undefined) ? prod.productChildItemSO : prod.productChildItemSOOverride);
                            ...
                            if (idx === (results.length - 1)) {
                                ...
                                if (prod.level < results[idx + 1].level) {
                                    prod.hasChildren = true;
                            ...
                            if (prod.level === 0) {
                                ...
                                prod.isRoot = false;
                                if (prod.level > results[idx - 1].level) {
                                    path.push(prod.parentProdName);
                                }
                                if (prod.level < results[idx - 1].level) {
                                    path.pop();
                                }
                                prod.breadcrumbs = path.slice(0);
                            }
                            productList.push(prod);
                        });
                        $scope.productList = productList;
                        console.log('Product Structure: ', $scope.productList);
                    });
                };

                $scope.toggleChildren = function(index, event) {
                    if (event) {
                        event.stopPropagation();
                    }
                ...
                $scope.addProdChildItem = function(item, event) {
                    if (event) {
                        event.stopPropagation();
                    }
                ...
                $scope.deleteProdChildItem = function(item, event) {
                    ...
                    modalScope.confirmationMsg = 'Are you sure you want to delete the product child item <i>' + item.productName + '</i>?';
                    modalScope.cancelActionLbl = 'Cancel';
                    modalScope.confirmActionLbl = 'Delete';
                    modalScope.confirmAction = function() {
                        var itemToDelete = item.productChildItemSO;
                        remoteActions.deleteObject(itemToDelete).then(function(results) {
                            console.log('delete product child item results: ', results);
                            $scope.getProductStructure();
                            deleteModal.hide();
                            //TODO: show delete success message
                        }, function(error) {
                            //TODO: show delete failure message
                ...
                $scope.viewProductChildDetails = function(item, event) {
                    ...
                    $scope.selectedProdId = item.productId;
                    var broadcastData = {
                        facetType: 'PROD_CHILD_DETAILS',
                        facetData: {
                            rootProductId: item.rootProdId,
                            productId: $scope.productId,
                            rootProductSpecId: $scope.productSpecId,
                            prodChildItem: item,
                            pricingMode: $scope.pricingMode
                        }
                    };
                ...
                $scope.$on('refreshStructureItems', function() {
                    $scope.getProductStructure();
                });
...
angular.module('productadmin')
.factory('productAdminService', ['$rootScope',
    function($rootScope) {
...
angular.module("productadmin").run(["$templateCache",function($templateCache){"use strict";$templateCache.put("AttributeRules.tpl.html",'<div class="vloc-attribute-rules">\n    <p>Attribute Rules placeholder..</p>\n</div>'),$templateCache.put("ProdInfo.tpl.html",'<div class="vloc-prod-info">\n    <p>Product Info goes here..</p>\n</div>'),$templateCache.put("ProductDetails.tpl.html",'<div class="vloc-product-details">\n    <div class="slds-clearfix">\n        <div class="slds-float--left prod-images" ng-if="attachments.length > 0">\n            <vloc-img-carousel attachments="attachments"></vloc-img-carousel>\n        </div>\n        <div class="slds-float--left prod-info">\n            <section class="vloc-section">\n                <h3 class="slds-text-heading--label">Product Details</h3>\n                <div class="vloc-section-body">\n                    <div class="slds-form--horizontal">\n                        <div class="slds-form-element slds-m-bottom--medium" ng-repeat="field in fieldSet">\n                            <label class="slds-form-element__label" for="{{objectFields[field.fieldPath].label}}">{{objectFields[field.fieldPath].label}}</label>\n                            <div class="slds-form-element__control">\n                                <vloc-obj-field display-mode="\'edit\'" parent-obj="editProduct" field-name="field.fieldPath" field-info="objectFields[field.fieldPath]" obj-picklists="objectPicklists[field.fieldPath.toLowerCase()]"></vloc-obj-field>\n                            </div>\n                        </div>\n                        <div class="slds-form-element slds-text-align--right">\n                            <button type="button" class="slds-button slds-button--brand" ng-click="saveProduct($event)">Save</button>\n                        </div>\n                    </div>\n                </div>\n            </section>\n        </div>\n        <div class="slds-float--right prod-publish">\n            <button type="button" class="slds-button slds-button--neutral" ng-click="publishProduct($event)">Publish Product</button>\n        </div>\n    </div>\n</div>'),$templateCache.put("ProductStructure.tpl.html",'<div class="vloc-product-structure">\n    <div class="slds-clearfix tbl-structure">\n        <div class="slds-float--left tbl-name">\n            <table class="slds-table slds-table--bordered prod-structure">\n                <thead>\n                    <tr class="slds-text-heading--label">\n                        <th class="prod-action"></th>\n                        <th class="prod-name">Product Name</th>\n                        <th class="prod-column">Code</th>\n                        <th class="prod-column">Spec Type</th>\n                        <th class="prod-column">Min, Max, Def</th>\n                    </tr>\n                </thead>\n                <tbody>\n                    <tr ng-repeat="p in productList" ng-if="p.show" ng-class="{\'pci-excluded\': p.excludePCI, \'slds-is-selected\': (p.productId === selectedProdId)}" ng-click="viewProductChildDetails(p, $event)">\n                        <td class="prod-action">\n                            <button class="slds-button slds-button--icon" ng-click="addProdChildItem(p, $event)">\n                                <slds-button-svg-icon sprite="\'utility\'" size="\'small\'" icon="\'new\'"></slds-button-svg-icon>\n                                <span class="slds-assistive-text">Add Product Child Item</span>\n                            </button>\n                            <button ng-if="!p.isRoot" class="slds-button slds-button--icon" ng-click="deleteProdChildItem(p, $event)">\n                                <slds-button-svg-icon sprite="\'utility\'" size="\'small\'" icon="\'delete\'"></slds-button-svg-icon>\n                                <span class="slds-assistive-text">Delete Product Child Item</span>\n                            </button>\n                        </td>\n                        <td class="prod-name">\n                            <div class="p-wrapper">\n                                <div ng-repeat="n in getNumber(p.level) track by $index" class="p-level"></div>\n                                <div class="p-expand">\n                                    <button ng-if="p.hasChildren && p.showChildren" class="slds-button slds-button--icon" ng-click="p.hasChildren && toggleChildren($index, $event)">\n                                        <slds-button-svg-icon sprite="\'utility\'" size="\'small\'" icon="\'chevrondown\'"></slds-button-svg-icon>\n                                        <span class="slds-assistive-text">Expand</span>\n                                    </button>\n                                    <button ng-if="p.hasChildren && !p.showChildren" class="slds-button slds-button--icon" ng-click="p.hasChildren && toggleChildren($index, $event)">\n                                        <slds-button-svg-icon sprite="\'utility\'" size="\'small\'" icon="\'chevronright\'"></slds-button-svg-icon>\n                                        <span class="slds-assistive-text">Expand</span>\n                                    </button>\n                                </div>\n                                <div class="p-name">\n                                    <a href="javascript:void(0)" ng-if="!p.isRoot" ng-click="launchTab(p.productSO, $event)" ng-class="{\'offer-spec\': (p.productChildItemSO[nsp+\'RelationshipType__c\'] === \'Realization\')}">{{p.productName}}</a>\n                                    <span ng-if="p.isRoot" ng-class="{\'offer-spec\': (p.productChildItemSO[nsp+\'RelationshipType__c\'] === \'Realization\')}">{{p.productName}}</span>\n                                </div>\n                            </div>\n                        </td>\n                        <td class="prod-column">\n                            <div ng-if="p.isRoot" ng-bind-html="formatFieldValue(p.productCode)"></div>\n                            <div ng-if="!p.isRoot" ng-bind-html="formatFieldValue(p.productSO[\'ProductCode\'])"></div>\n                        </td>\n                        <td class="prod-column">\n                            <div ng-if="p.isRoot" ng-bind-html="formatFieldValue(p.specType)"></div>\n                            <div ng-if="!p.isRoot" ng-bind-html="formatFieldValue(p.productSO[nsp+\'SpecificationType__c\'])"></div>\n                        </td>\n                        <td class="prod-column">\n                            <span ng-class="{\'overridden-value\': p.productChildItemSOOverride}" ng-bind-html="formatFieldValue(p.productChildItemSO[nsp+\'MinMaxDefaultQty__c\'])"></span>\n                            <span ng-if="p.productChildItemSOOverride" class="slds-m-left--x-small" ng-bind-html="formatFieldValue(p.productChildItemSOOverride[nsp+\'MinMaxDefaultQty__c\'])"></span>\n                        </td>\n                    </tr>\n                </tbody>\n            </table>\n        </div>\n    </div>\n</div>')}]);
},{}],43:[function(require,module,exports){
angular.module('promotionadmin')
.controller('PromotionAdminController', ['$scope', '$rootScope', '$location', '$timeout', '$compile', 'remoteActions',
    function ($scope, $rootScope, $location, $timeout, $compile, remoteActions) {
        ...
        $scope.getObject = function(promotionId) {
            remoteActions.getObject(promotionId).then(function(results) {
                console.log('getObject results: ', results);
                $scope.promotion = results;
                $scope.editPromotion = {};
                for (var key in $scope.promotion) {
                    $scope.editPromotion[key] = $scope.promotion[key];
                }
            });
        };

        $scope.getContextCriteria = function(promotionId) {
            console.log('getContextCriteria for: ', promotionId);
            remoteActions.getContextCriteria(promotionId).then(function(results) {
                console.log('getContextCriteria results: ', results);
                $scope.contextCriteria = results;
                $rootScope.$broadcast('setContextCriteria', $scope.contextCriteria);
            });
        ...
        $scope.createItem = function(event) {
            ...
            var itemToSave = {};
            for (var key in $scope.editPromotion) {
                if (key !== '$$hashKey') {
                    itemToSave[key] = $scope.editPromotion[key];
                }
            }

            remoteActions.createObject($scope.nsp + $scope.OBJECT_NAME, itemToSave).then(function(results) {
                console.log('create promotion results: ', results);
                for (var key in results) {
                    $scope.promotion[key] = results[key];
                    $scope.editPromotion[key] = results[key];
                }
                if (event) {
                    event.currentTarget.innerText = originalText;
                    event.currentTarget.disabled = false;
                ...
                window.location = '/apex/PromotionAdmin?id=' + results.Id + '&name=' + results.Name;
            }, function(error) {
                //TODO: show save failure message
                if (event) {
                    event.currentTarget.innerText = 'Error!';
        ...
        $scope.saveItem = function(event) {
            ...
            for (var key in $scope.editPromotion) {
                if (key !== '$$hashKey') {
                    itemToSave[key] = ($scope.editPromotion[key] === null ? undefined : $scope.editPromotion[key]);
                }
            }
            ...
            remoteActions.updateObject(itemToSave).then(function(results) {
                ...
                for (var key in results) {
                    if ($scope.objectFields[key] && $scope.objectFields[key].type === 'DATE') {
                        ...
                        $scope.editPromotion[key] = results[key] + tzOffset;
                    } else {
                        $scope.promotion[key] = results[key];
                        $scope.editPromotion[key] = results[key];
                    }
        ...
        $scope.openFacetDetails = function(facetType, facetData) {
            ...
            if (facetType === 'PROMOTION_PRODUCT') {
                ...
                $scope.contextCriteriaItem = facetData.contextCriteriaItem;
                compiledHTML = $compile('<vloc-context-rule item="contextCriteriaItem" parent-item="promotion" mode="\'leftPane\'"></vloc-context-rule>')($scope);
                j$('#facet-detail-content').html(compiledHTML);
            } else if (facetType === 'PROD_CHILD_DETAILS') {
                ...
                $scope.pricingMode = facetData.pricingMode;
                $scope.isAdj = facetData.isAdj;
                directiveHTML = '<vloc-pricing-element object-id="promotionId" pricing-element-item="pricingElementItem" parent-item="promotion" pricing-mode="pricingMode" is-adj="isAdj"></vloc-pricing-element>';
                compiledHTML = $compile(directiveHTML)($scope);
                j$('#facet-detail-content').html(compiledHTML);
            }
            $scope.showFacetDetail = true;
        ...
        $scope.init = function() {
            ...
            if ($scope.mode === 'new') {
                ...
                // $scope.getObjectLayoutById($scope.promotionId, true);
...
angular.module('promotionadmin')
.directive('vlocPromoProdDiscounts', ['remoteActions',
    function(remoteActions) {
        return {
            scope: {
                customViewAttrs: '='
            ...
            replace: true,
            restrict: 'E',
            templateUrl: 'PromoProdDiscounts.tpl.html',
            controller: function($scope, $rootScope, $sldsModal, $compile) {
                console.log('INIT PromoProdDiscounts: ', $scope.customViewAttrs);
                ...
                $scope.$on('refreshStructureItems', function() {
                    $scope.getPromoStructure();
                });

                $scope.getPromoStructure = function() {
                    remoteActions.getPromotionApplicableProducts($scope.promotionId, 'FULLHIERARCHY').then(function(results) {
                        var promoList = [];
                        var fullProductList = [];
                        angular.forEach(results, function(item, idx) {
                            if ('Name' in item) {
                                ...
                                var lastPromoItemIdx = promoList.length - 1;
                                var promoItem = promoList[lastPromoItemIdx];

                                var productList = [];
                                var path = [];
                                angular.forEach(item, function(prod, idx) {
                                    prod.pciObj = ((prod.productChildItemSOOverride === undefined) ? prod.productChildItemSO : prod.productChildItemSOOverride);
                                    ...
                                    if (idx === (item.length - 1)) {
                                        ...
                                        if (prod.level < item[idx + 1].level) {
                                            prod.hasChildren = true;
                                            prod.showChildren = true;
                                        } else {
                                            prod.hasChildren = false;
                                    ...
                                    productList.push(prod);
                                    fullProductList.push(prod);
                                });

                                promoItem.prodStruct = productList;
                            }
                        });
                        $scope.promoList = promoList;
                        $scope.fullProductList = fullProductList;
                        console.log('!!! fullProductList: ', $scope.fullProductList);
                        /*
                        var productList = [];
                        var path = [];
                        angular.forEach(results, function(prod, idx) {
                ...
                $scope.viewProductChildDetails = function(item, event) {
                    ...
                    $scope.selectedProdId = item.productId;
                    var rootProdId = (item.rootProdId ? item.rootProdId : item.productId);

                    var broadcastData = {
                        facetType: 'PROD_CHILD_DETAILS',
                        facetData: {
                            promotionId: $scope.promotionId,
                            rootProductId: rootProdId,
                            rootProductSpecId: null,
                            prodChildItem: item,
                            pricingMode: $scope.pricingMode
                        }
                    };
...
angular.module('promotionadmin')
.directive('vlocPromotionProduct', ['remoteActions',
    function(remoteActions) {
        return {
            scope: {
                promotionItem: '=',
            ...
            controller: function($scope, $rootScope) {
                ...
                $scope.getObjectTypes = function(item) {
                    ...
                    $scope.selectObjectType = false;
                    remoteActions.getObjectTypes(item).then(function(results) {
                        console.log('PromotionProduct getObjectTypes results:', results);
                        for (var i = 0; i < results.length; i++) {
                            $scope.selectObjectType = true;
                            var res = {
                                label: results[i].Name,
                ...
                $scope.saveItem = function(event) {
                    ...
                    var itemToSave = {};
                    console.log('save promo item editItem',$scope.editItem);
                    for (var key in $scope.editItem) {
                        if (key !== '$$hashKey') {
                            itemToSave[key] = ($scope.editItem[key] === null ? undefined : $scope.editItem[key]);
                        }
                ...
                $scope.init = function() {
                    console.log('PromotionProduct INIT:', $scope.promotionItem);
                    if ($scope.promotionItem.Id === undefined) {
                        ...
                        $scope.getObjectLayoutById($scope.promotionItem.Id, true);
...
angular.module('promotionadmin')
.directive('vlocPromotionProducts', ['remoteActions',
    function(remoteActions) {
        return {
            scope: {
                customViewAttrs: '='
            ...
            controller: function($scope, $rootScope, $sldsModal, $compile) {
                ...
                $scope.getApplicableProducts = function() {
                    console.log('getApplicableProducts promoId: ', $scope.promotionId);
                    remoteActions.getPromotionApplicableProducts($scope.promotionId, 'ITEMS_ONLY').then(function(results) {
